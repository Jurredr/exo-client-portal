...
export const ADMIN_EMAIL_DOMAIN = "@jurre.me";

/** @deprecated Use EXO_COMPANY.name from "@/lib/constants/exo-company" */
export const EXO_ORGANIZATION_NAME = EXO_COMPANY.name;
